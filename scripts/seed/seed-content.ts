...
export async function seedContent(media: SeededMediaMap): Promise<void> {
  ...
  await setDoc(
    doc(db, "siteSettings", "global"),
    {
      ...
      headline: "Lead CloudOps & DevOps Architect",
      shortBio:
      ...
      logoUrl: media.logoUrl || "/assets/sachin-logo.png",
      avatarUrl: media.heroPhotoUrl || "/assets/sachin-one.png",
  ...
  const sections = [
    {
      ...
      content: {
        ...
        headline: "Architecting Resilient Multi-Cloud Platforms",
        subheadline:
    ...
    },
    {
      ...
      isVisible: true,
      content: {
        heading: "Architecture Metrics & Cost Optimization",
        subheading:
          "Interactive dashboard displaying real-time cloud spend reduction curves, MTTR resolution benchmarks, and fleet distribution.",
      },
    },
    {
    ...
    // Dynamic Page sections: cloud-architecture
    {
      ...
      type: "telemetry",
      title: "Cloud Architecture & Cost Metrics",
      order: 0,
      isVisible: true,
      content: {},
    },
    ...
    },
    {
      ...
      content: {
        ...
        body: "All infrastructure deployments are managed as immutable code via GitOps pipelines with integrated FinOps cost checks, least-privilege RBAC policies, and comprehensive Datadog/Dynatrace observability metrics.",
        ctaText: "Return to Public Site",
        ctaUrl: "/",
