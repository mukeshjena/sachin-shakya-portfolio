  ...
  return (
    ...
    >
      <div
        ...
        className="pointer-events-auto flex items-center justify-between gap-2.5 p-1.5 rounded-full bg-[var(--ink-900)]/85 backdrop-blur-2xl border border-[var(--line)]"
      >
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`relative w-11 h-11 rounded-full flex items-center justify-center transition-colors cursor-pointer select-none ${
                isActive
                  ? "text-[var(--amber)]"
