...
// Relativistic Kerr/Schwarzschild Geodesic Raymarching & Multi-Pass Shaders.
// Adapted from 21st.dev (Yura Oak) for Clean Architecture and Instrument Panel visual standards.
...
export const BLACKHOLE_FRAGMENT_SHADER = `
